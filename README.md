...
#### 구현 영상
https://user-images.githubusercontent.com/114119404/199552452-6e380a5c-4c91-4316-bfab-f0d11e1035ff.mp4
...
#### 몬스터
> ● 일반몬스터    
> 플레이어가 공격을 하면 해당 몬스터의 패턴을 사용한다. (40%)   
...
> Hp는 농장에서 천천히 차며, 사냥터에서는 작물을 먹어야 회복시킬 수 있다. (30%)

#### 작물
> 작물마다 공격력, 공격속도, 공격범위가 다르다. (90%)   
...
> ● 보스 몬스터    
> 플레이어 위치에 근접한 몬스터는 플레이어를 공격하러 온다. (0%)     
> 플레이어가 몬스터를 때리면 일반 몬스터와는 다르게 가운데 상단에 보스 몬스터의 이름과 체력이 뜬다. (0%)     
> 플레이어의 위치가 어디에 있든 공격을 시작한 보스 몬스터는 맵을 벗어나지 않은 이상 계속 따라오게 된다. (100%)      
> 플레이어가 공격을 하면 보스 몬스터는 패턴을 사용한다. (40%)     
